...
export function decideNextAction(state, diagnosis) {
  ...
  return {
    ...
    suggested_method: "我会一次问一个问题。先说：如果这个方向今天真的前进了一小步，你的现实生活里会出现什么看得见的变化？",
    completion_criteria: "能说出一个具体场景、一项可观察变化，以及你愿意尝试的最小行动。",
    completion_evidence: "能说出一个具体场景、一项可观察变化，以及你愿意尝试的最小行动。",
    expected_gain: "把长期方向落到一个今天真实可见的场景，避免用一张固定计划替代判断。",
