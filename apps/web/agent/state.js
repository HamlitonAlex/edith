export function createAgentState(now = new Date()) {
  return {
    ...
    phase: "decide",
    current_stage: "把想法变成可验证的个人产品",
    long_term_goals: [
      { id: "build-xuecheng", text: "完成并公开发布一个真正可安装的私人教育伙伴", confidence: 0.96, source: "连续对话" },
    ],
    active_goals: ["用学程项目训练 AI 协作、产品判断与持续执行"],
    interests: ["AI 应用", "产品设计", "真实项目", "通识"],
    skills: {
      ai_application: { label: "AI 应用", level: "developing", confidence: 0.62, evidence: ["持续推进学程项目"] },
      product: { label: "产品能力", level: "developing", confidence: 0.58, evidence: ["能持续指出产品与现实生活的距离"] },
      general_knowledge: { label: "通识结构", level: "unknown", confidence: 0.2, evidence: [] },
    },
    recent_learning: [],
    recent_events: [],
    current_constraints: ["不希望依赖每日手工记录", "主要使用 iPhone 与 Windows"],
    pending_items: [],
